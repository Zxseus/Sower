...
# Support
GROUP = os.environ.get("GROUP", "Blvckcards")
CHANNEL = os.environ.get("CHANNEL", "VerifiedAccount_ID")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Blvckcards")
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Blvckcards v{BOT_VER} is back up and running!**\n\n"
